...
const MusicPlayer = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="player bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        <div className="player-bar flex justify-between items-center p-4 bg-gray-900">
          <div className="parallel-lines flex space-x-2">
            <div className="w-1 h-6 bg-gray-700"></div>
            <div className="w-1 h-6 bg-gray-700"></div>
          </div>
          <h1 className="fcc-title text-white text-xl font-bold">freeCodeCamp</h1>
          <div className="parallel-lines flex space-x-2">
            <div className="w-1 h-6 bg-gray-700"></div>
            <div className="w-1 h-6 bg-gray-700"></div>
          </div>
        ...
        <div className="player-content p-4">
          ...
          <div className="player-display mt-4">
            <div className="player-display-song-artist text-center">
              <p id="player-song-title" className="text-white text-lg font-semibold">Song Title</p>
              <p id="player-song-artist" className="text-gray-400">Artist Name</p>
            </div>
            <div className="player-buttons flex justify-center space-x-4 mt-4">
              <button id="previous" className="previous text-white hover:text-gray-400">
                <svg
                  width="24"
                  height="19"
                  viewBox="0 0 24 19"
              ...
              <button
                id="play"
                className="play text-white hover:text-gray-400"
                onClick={togglePlay}
              >
                {isPlaying ? (
                  <svg
              ...
              <button id="next" className="next text-white hover:text-gray-400">
                <svg
                  width="24"
                  height="19"
                  viewBox="0 0 24 19"
              ...
              <button id="shuffle" className="shuffle text-white hover:text-gray-400">
                <svg
                  width="17"
                  height="14"
                  viewBox="0 0 17 14"
      ...
      <div className="playlist bg-gray-800 rounded-lg shadow-lg mt-4">
        <div className="playlist-bar flex justify-between items-center p-4 bg-gray-900">
          <div className="parallel-lines flex space-x-2">
            <div className="w-1 h-6 bg-gray-700"></div>
            <div className="w-1 h-6 bg-gray-700"></div>
          </div>
          <h2 className="playlist-title text-white text-xl font-bold">Playlist</h2>
          <div className="parallel-lines flex space-x-2">
            <div className="w-1 h-6 bg-gray-700"></div>
            <div className="w-1 h-6 bg-gray-700"></div>
          </div>
        </div>
        <ul id="playlist-songs" className="p-4">
          {/* Aquí puedes agregar las canciones de la playlist */}
        </ul>
      </div>
    </div>
  );
